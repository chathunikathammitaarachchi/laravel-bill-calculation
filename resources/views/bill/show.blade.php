...
">
    <div style="text-align: center; border-bottom: 3px solid #5686bdff; margin-bottom: 25px; padding-bottom: 15px;">
        <h2 style="margin: 0; font-size: 28px; font-weight: 700; color: #333;">Bill No: {{ $bill->grn_no }}</h2>
        <p style="margin: 4px 0; font-size: 16px; color: #666;"><strong>Date:</strong> {{ $bill->g_date }}</p>
        <p style="margin: 4px 0; font-size: 16px; color: #666;"><strong>Customer Name:</strong> {{ $bill->supplier_name }}</p>
    </div>
